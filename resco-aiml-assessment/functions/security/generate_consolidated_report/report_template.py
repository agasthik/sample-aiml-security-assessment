    ...
    <div class="layout">
        ...
        <main class="main">
            ...
            <section id="risk" class="section">
                ...
                <div class="metrics">
                    <div class="metric"><div class="metric-label"><span class="service-badge bedrock" style="width: 18px; height: 18px; font-size: 10px;">B</span> Bedrock</div><div class="metric-value">{bedrock_total}</div><div class="metric-sub">{bedrock_failed} Failed · {bedrock_passed} Passed</div></div>
                    <div class="metric"><div class="metric-label"><span class="service-badge sagemaker" style="width: 18px; height: 18px; font-size: 10px;">S</span> SageMaker</div><div class="metric-value">{sagemaker_total}</div><div class="metric-sub">{sagemaker_failed} Failed · {sagemaker_passed} Passed</div></div>
                    <div class="metric"><div class="metric-label"><span class="service-badge agentcore" style="width: 18px; height: 18px; font-size: 10px;">A</span> AgentCore</div><div class="metric-value">{agentcore_total}</div><div class="metric-sub">{agentcore_failed} Failed · {agentcore_passed} Passed</div></div>
                </div>
            </section>
            ...
            <section id="methodology" class="section">
                ...
                <div class="card"><div class="card-header"><h3>Assessment Scope</h3></div><div class="card-body"><p style="color: var(--text-2); font-size: 13px; margin-bottom: 12px;">This assessment evaluates security configurations for the following AWS AI/ML services:</p><div style="display: flex; gap: 12px; flex-wrap: wrap;"><div style="display: flex; align-items: center; gap: 8px; padding: 8px 12px; background: var(--surface-2); border-radius: 6px;"><span class="service-badge bedrock" style="width: 20px; height: 20px; font-size: 10px;">B</span><span style="font-size: 13px; font-weight: 500;">Amazon Bedrock</span></div><div style="display: flex; align-items: center; gap: 8px; padding: 8px 12px; background: var(--surface-2); border-radius: 6px;"><span class="service-badge sagemaker" style="width: 20px; height: 20px; font-size: 10px;">S</span><span style="font-size: 13px; font-weight: 500;">Amazon SageMaker</span></div><div style="display: flex; align-items: center; gap: 8px; padding: 8px 12px; background: var(--surface-2); border-radius: 6px;"><span class="service-badge agentcore" style="width: 20px; height: 20px; font-size: 10px;">A</span><span style="font-size: 13px; font-weight: 500;">Amazon Bedrock AgentCore</span></div></div><p style="color: var(--text-3); font-size: 12px; margin-top: 12px;">Checks are based on AWS Well-Architected Framework (Generative AI Lens), AWS security best practices, and service-specific security documentation.</p></div></div>
            </section>
        </main>
    </div>
    <script>
...
def generate_html_report(
    ...
    passed_count = sum(1 for f in all_findings if f.get('status', f.get('Status', '')).lower() == 'passed')
