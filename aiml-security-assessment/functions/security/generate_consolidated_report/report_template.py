...
def generate_html_report(
    ...
    return html_template.format(
        ...
        bedrock_total=service_stats.get('bedrock', {}).get('passed', 0) + service_stats.get('bedrock', {}).get('failed', 0) + service_stats.get('bedrock', {}).get('na', 0),
        bedrock_failed=service_stats.get('bedrock', {}).get('failed', 0),
        bedrock_passed=service_stats.get('bedrock', {}).get('passed', 0),
        sagemaker_total=service_stats.get('sagemaker', {}).get('passed', 0) + service_stats.get('sagemaker', {}).get('failed', 0) + service_stats.get('sagemaker', {}).get('na', 0),
        sagemaker_failed=service_stats.get('sagemaker', {}).get('failed', 0),
        sagemaker_passed=service_stats.get('sagemaker', {}).get('passed', 0),
        agentcore_total=service_stats.get('agentcore', {}).get('passed', 0) + service_stats.get('agentcore', {}).get('failed', 0) + service_stats.get('agentcore', {}).get('na', 0),
