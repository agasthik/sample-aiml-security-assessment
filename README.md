...
- **[127 Security Checks](docs/SECURITY_CHECKS.md)** across Amazon Bedrock, Amazon SageMaker AI, Amazon Bedrock AgentCore, and Financial Services GenAI Risk
...
| **Inconsistent security checks across teams** | Standardized 127-check assessment based on AWS Well-Architected Generative AI Lens best practices and AWS Responsible AI governance, risk, and compliance guidance for financial services |
...
**Services Covered:**
- **[Amazon Bedrock](docs/SECURITY_CHECKS.md#amazon-bedrock-security-checks-25)** (25 checks) - Guardrails, cross-account policies, guardrail tiers, content filters, automated reasoning, encryption, Amazon VPC endpoints, AWS IAM permissions, model invocation logging, model evaluation, prompt flow validation, RAG evaluation, service quotas
...
**127 checks across four domains.** The assessment covers Amazon Bedrock, Amazon SageMaker AI, Amazon Bedrock AgentCore, and optional Financial Services GenAI risk checks. Other AI/ML services (Amazon Comprehend, Amazon Rekognition, Amazon Textract, and others) are not currently assessed.
...
|----------|-------------|
| [Security Checks Reference](docs/SECURITY_CHECKS.md) | Complete reference for all 127 security checks with severity levels |
